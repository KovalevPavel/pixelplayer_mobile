...
import kov_p.pixelplayer.feature_albums.di.AlbumDetailsScope
import kov_p.pixelplayer.feature_albums.di.AlbumsScope
import kov_p.pixelplayer.feature_albums.di.detailsModule
...
fun AlbumDetailComposable(
    ...
    val scope = remember(albumId) {
        koin.loadModules(listOf(detailsModule))
        koin.getOrCreateScope<AlbumDetailsScope>("${AlbumDetailsScope}:$albumId")
    }
    ...
    val viewModel: AlbumDetailViewModel = remember(albumId, scope) {
